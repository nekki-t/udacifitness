  ...
  setLocation = () => {
    Location.watchPositionAsync({
      ...
      if(newDirection !== direction) {
        Animated.sequence([
          Animated.timing(bounceValue, { duration: 200, toValue: 1.84 }),
    ...
    if (status === 'denied') {
      return (
        <View style={styles.center}>
          ...
          <Text>
            You denied your location. you can fix this by visiting your settings and enabling location service for this
            app.
          </Text>
        </View>
      )
